...
namespace VCX::Labs::GeometryProcessing {
    ...
    App::App() :
        ...
        _caseSimplification(_viewer, { ExampleModel::Cube, ExampleModel::Sphere, ExampleModel::Block, ExampleModel::Dinosaur, ExampleModel::Fandisk, ExampleModel::Rocker, ExampleModel::Arma }),
