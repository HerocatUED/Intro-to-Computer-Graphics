...
target("final-project")
    ...
    after_build(function (target)
        os.cp("src/VCX/Labs/FinalProject/shaders/*", path.join(target:targetdir(), "assets", "shaders"))
    end)
    after_install(function (target)
        os.cp("src/VCX/Labs/FinalProject/shaders/*", path.join(target:installdir(), "bin", "assets", "shaders"))
    end)
